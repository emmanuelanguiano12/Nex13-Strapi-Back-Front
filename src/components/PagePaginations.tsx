...
const PagePaginations = ({pagination} : Props) => {
    ...
    const clasNumberActive = "flex items-center justify-center px-3 h-8 text-blue-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white"
        ...
        <ul className="inline-flex -space-x-px text-sm">
            ...
            </li>
            {
                ...
                <li>
                    ...
                    className={
                        `${index + 1 === page ? clasNumberActive : classNumber}`
                    }>
                        {index + 1}
                    </Link>
                </li>
